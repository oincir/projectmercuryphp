	...
	<div class="container-login100" >
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                Whitening Sponge Update Product: <?php echo $_SESSION["jcode"];?>
                </span>
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if (isset($_POST['back'])) {
            ...
            header('Location:productOperationUI.php');  
                ...
                //check the personnel
                $query = "SELECT * FROM mercury.personnel_table WHERE id='".$p1_id."';";
                $p1_response = @mysqli_query($dbc, $query);

                if($p1_response ){
                    $query = "CALL mercury.UpdateSponge('".$_SESSION['product_id']."','".$_POST['p1_id']."') ;";
